...
#BING DORKER | CODED BY KRISSH KUMAR| HACKING IS ♥
...
system("BING DORKER | CODED BY KRISSH KUMAR");
if ($^O =~ /MSWin32/) {system("cls"); }else { system("clear"); }
...
print color('bold red'),"] ";
print color("bold yellow"),"Bing Doker     |> Choose The Country That You Want\n";
print color('bold red'),"[";
print color('bold green'),"2";
print color('bold red'),"] ";
print color("bold white"),"Bing Dorker    |> Here I Will Grab Using Your Dork World Wide Websites\n";
print color('bold red'),"[";
print color('bold green'),"3";
print color('bold red'),"] ";
print color("bold green"),"Mass Site Grab |> By Ip or Websites List\n";
print color('bold red'),"[";
...
print color('bold green'),"+";
print color('bold red'),"] ";
print color("bold green"),"[Here You Can Choose The Country Dork exp: inurl:.php?id= site: co.in ]\n";
print color('bold red'),"[";
print color('bold green'),"+";
print color('bold red'),"] ";
...
print color('bold green'),"+";
print color('bold red'),"] ";
print color("bold white"),"[Enter Your Dork And I will Scan All World Sites ]\n";
print color('bold red'),"[";
print color('bold green'),"+";
print color('bold red'),"] ";
print color("bold white"),"Give me Dork:";
...
my $list=<STDIN>;
chomp($list);
        open (THETARGET, "<$list") || die "[-] Enter Correct list ?!";
@TARGETS = <THETARGET>;
close THETARGET;
$link=$#TARGETS + 1;
...
my $list=<STDIN>;
chomp($list);
        open (THETARGET, "<$list") || die "[-] Enter List Lol ?!";
@TARGETS = <THETARGET>;
close THETARGET;
$link=$#TARGETS + 1;
